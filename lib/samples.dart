...
//
  ...
  static Quiz kakaodog = Quiz(rows: [
    Chunks(counts: [6]),
    Chunks(counts: [2, 2, 5]),
  ...
  static Quiz moyashimon = Quiz(rows: [
    Chunks(counts: [30]),
  ...
  static Quiz soyo2_247 = Quiz(
    rows: [
      Chunks(counts: [6]),
      Chunks(counts: [3, 2]),
      Chunks(counts: [2, 4, 1]),
      Chunks(counts: [1, 8, 1]),
      Chunks(counts: [1, 1, 6, 1, 1]),
      //
      Chunks(counts: [1, 4, 6, 1]),
      Chunks(counts: [1, 10, 1]),
      Chunks(counts: [3, 9, 2]),
      Chunks(counts: [1, 2, 5, 1]),
      Chunks(counts: [1, 2, 1]),
      //
      Chunks(counts: [1, 1, 3, 1]),
      Chunks(counts: [1, 1, 1, 1, 1, 1]),
      Chunks(counts: [1, 1, 1, 1, 2, 1]),
      Chunks(counts: [1, 2, 1, 1, 1]),
      Chunks(counts: [1, 1, 2, 2, 2]),
      //
      Chunks(counts: [2, 2, 8, 3]),
      Chunks(counts: [2, 2]),
      Chunks(counts: [2, 3]),
      Chunks(counts: [3, 5]),
      Chunks(counts: [11]),
    ...
    cols: [
      ...
      Chunks(counts: [1, 2]),
      Chunks(counts: [1, 5, 2]),
      Chunks(counts: [1, 1, 2, 1]),
      Chunks(counts: [5, 2, 1, 1]),
      //
      Chunks(counts: [2, 1, 1, 1, 1, 1]),
      Chunks(counts: [2, 3, 3, 1, 2]),
      Chunks(counts: [1, 1, 3, 1, 2, 1]),
      Chunks(counts: [1, 5, 1, 1]),
      Chunks(counts: [1, 6, 1, 1]),
      //
      Chunks(counts: [1, 3, 3, 1, 1]),
      Chunks(counts: [1, 7, 1, 1]),
      Chunks(counts: [1, 7, 1, 1]),
      Chunks(counts: [1, 7, 1, 2]),
      Chunks(counts: [1, 1, 3, 2, 2]),
      //
      Chunks(counts: [1, 4, 1, 2]),
      Chunks(counts: [1, 1, 2, 3]),
      Chunks(counts: [2, 1, 3, 4]),
      Chunks(counts: [6, 4]),
      Chunks(counts: [5]),
    ],
  );
